...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002147792011'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7040444713').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002099225836').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002099225836')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/moviebot_channel')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'disssuss_bot') # Support Chat Link Without https:// or @
